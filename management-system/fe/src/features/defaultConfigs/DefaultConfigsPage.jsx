...
import { getServiceOptions } from './defaultConfigs.helpers';
  ...
  return (
    <div className="page-content">
      ...
      <section className="table-card">
        ...
        <DefaultConfigsTable configs={configs} busyId={busyId} onEdit={(config) => setModal({ mode: 'edit', config })} onToggle={handleToggle} onDelete={handleDelete} />
      </section>
